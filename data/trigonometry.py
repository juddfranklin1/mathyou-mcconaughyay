...
TRIGONOMETRY_CONCEPTS = {
    ...
    "Pythagorean Identities": {
        ...
        "mathematical_demonstration": "Suppose you know that for a certain angle $\theta$ in the first quadrant, $\sin\theta = \frac{3}{5}$. What is $\cos\theta$?<br>1. Start with the identity: $\sin^2\theta + \cos^2\theta = 1$.<br>2. Plug in the known value: $(\frac{3}{5})^2 + \cos^2\theta = 1$.<br>3. Simplify: $\frac{9}{25} + \cos^2\theta = 1$.<br>4. Solve for $\cos^2\theta$: $\cos^2\theta = 1 - \frac{9}{25} = \frac{16}{25}$.<br>5. Take the square root: $\cos\theta = \pm\sqrt{\frac{16}{25}} = \pm\frac{4}{5}$.<br>Since we are in the first quadrant, cosine is positive, so $\cos\theta = \frac{4}{5}$. You found one trig value from another without even knowing the angle!",
